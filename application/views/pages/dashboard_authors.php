...
<div class="container">
    ...
    $waitingCount = 2; // Example count of articles waiting review
    $inReviewCount = 5; // Example count of articles in review
    $publishedCount = 2; // Example count of published articles
    $rejectedCount = 1; // Example count of rejected articles
    ?>
