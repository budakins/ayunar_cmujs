...
<body>
        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="<?php echo base_url('home/contact_admin'); ?>">Archives</a></li>
                </ul>
    ...
    <!-- Page Header-->
    <header class="masthead" style="background-image: url('<?php echo base_url('assets/img/fullbright.jpg'); ?>')">           
