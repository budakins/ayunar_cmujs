...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url('assets/img/cmujs.png')?>">
    <!-- Custom CSS -->
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link"href="<?php echo base_url('pages/db_authorList') ?>" aria-expanded="false">
                                ...
                                <span class="hide-menu">Manage Author</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link"href="<?php echo base_url('volume/db_Volumes') ?>" aria-expanded="false">
                                ...
                                <span class="hide-menu"> Manage Volumes</span>
                            </a>
                        </li>
